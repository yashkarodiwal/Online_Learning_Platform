...
const EditCourse = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            await axios.put(`${import.meta.env.VITE_API_URL}/api/courses/${id}`, formData, authHeaders);
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.delete(`${import.meta.env.VITE_API_URL}/api/courses/${id}`, authHeaders);
